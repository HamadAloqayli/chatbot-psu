    ...
    <div className="bg-white shadow-lg rounded-l-lg h-[600px] py-4 px-4 w-full max-w-[300px] flex flex-col justify-between">
      <div className="flex flex-col">
        <img
          ...
          alt=""
          className="w-20 h-20 mx-auto object-cover rounded-full border-4 border-teal-400 mb-8"
        />
      ...
      <div className="mt-auto">
        <button className="flex justify-start items-center bg-gray-100 text-red-700 my-4 rounded-md w-full text-left py-2 px-2 space-x-4">
          <HiOutlineLogout />
          <span>Logout</span>
        </button>
      </div>
