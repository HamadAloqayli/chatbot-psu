...
function ProfileArea() {
  return (
    <div className="bg-white shadow-lg rounded-l-lg h-[600px] py-4 px-4 w-full max-w-[300px] flex flex-col justify-between">
      <div className="flex flex-col">
        <div className="mb-6">
          <img
            ...
            alt=""
            className="w-20 h-20 mx-auto object-cover rounded-full border-4 border-teal-400 "
          />
          <p className="text-center  text-gray-600 mt-2">Khalid Abdulaziz</p>
          <p className="text-center text-sm  text-gray-400">436106399</p>
        </div>

        <div>
          <button className="flex justify-start items-center bg-gray-100 text-gray-700 my-3 rounded-md w-full text-left py-2 px-2 space-x-4">
            <AiFillHome />
            <span>Home</span>
          </button>
        </div>
        ...
        <div>
          <button className="flex justify-start items-center  text-gray-700 my-3 rounded-md w-full text-left py-2 px-2 space-x-4">
            <BsFillPersonFill />
            <span>Profile</span>
          </button>
        </div>
      ...
      <div className="mt-auto">
        <button className="flex justify-start items-center bg-red-50  text-red-700 my-4 rounded-md w-full text-left py-2 px-2 space-x-4">
          <HiOutlineLogout />
          <span>Logout</span>
        </button>
      </div>
