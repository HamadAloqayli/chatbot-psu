...
function Header() {
  return (
    <div className="bg-white fixed top-0 left-0 z-20 w-full h-16 flex justify-between items-center p-4 shadow-lg">
      ...
      <div className="hidden lg:flex justify-center items-center divide-x-2">
        <div className="flex flex-col justify-center items-center px-6">
          <span className="text-xs text-gray-400 mb-1">Dark Mode</span>
          <label className="relative inline-flex items-center cursor-pointer">
            <input type="checkbox" value="" className="sr-only peer" />
            <div className="w-[60px] h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-[35px] peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
          </label>
        </div>
        ...
        <div className="flex justify-center items-center space-x-2 px-6">
          <img
            ...
            alt=""
            className="w-12 h-12 object-cover rounded-full border-4 border-teal-400 "
          />
          <div>
            <p className="text-gray-600 mt-2 font-bold">Khalid Abdulaziz</p>
            <p className="text-sm text-gray-400">436106399</p>{" "}
          </div>
        </div>
      </div>

      <button className="blcok lg:hidden text-2xl">
        <GrMenu />
      </button>
    </div>
  );
